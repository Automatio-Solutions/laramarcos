      ...
      <div className="grid gap-8 lg:grid-cols-5">
        ...
        <div className="space-y-8 lg:col-span-3">
          ...
          <section className="space-y-3">
            ...
            <form action={updateDescripcionAction.bind(null, id)} className="space-y-2">
              <textarea
                name="descripcion"
                defaultValue={tarea.descripcion ?? ""}
                rows={4}
                placeholder="Añade cualquier información de la tarea: contexto, instrucciones, datos del cliente…"
                className="w-full rounded-md border border-border bg-surface px-3 py-2 text-sm text-fg"
              />
              <div className="flex justify-end">
                <button className="rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-[var(--color-primary-hover)]">Guardar descripción</button>
              </div>
            </form>
          </section>
